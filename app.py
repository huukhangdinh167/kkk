...
cred = credentials.Certificate('./iuh-20047741-5f957-firebase-adminsdk-c8j0k-de55f03e40.json')
appLoadData = firebase_admin.initialize_app(cred)

dbFireStore = firestore.client()

queryResults = list(dbFireStore.collection(u'tbl-20047741').stream())
...
app.layout = html.Div(
    children=[
        html.Div(
            children=[
                html.H3(
                    "Trường: IUH, Lớp: DHHTTT16C Đinh Hữu Khang-20047741", className="header-title"
